...
@section('content')
    <div class="box box-default">
            <div class="box-tools pull-right" style="text-align: right;">
                <a href="{{ route('tipo_custo.create') }}" class="btn pull-right"><i class="fa fa-plus"></i> Adicionar</a>
            </div>
        <div class="box-header with-border">
            <h3 class="box-title">Pesquisa</h3>
        </div>
        {!! Form::open(['route' => 'tipo_custo.index', 'method'=>'get', 'class'=>'form']) !!}
        <div class="box-body">
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="box">
        ...
        <div class="box-body ">
            @include('tipo_custo.list')
            {!! $tipo_custos->appends(['q' => $q])->links() !!}
        </div>
    </div>
@stop
